...
export class SelectComponent implements OnInit, ControlValueAccessor {
  ...
  connectingRemote: boolean = false;
  ...
  public loadRemoteData(typed: string) {
    ...
    delay(() => {
      ...
      if (this.remoteConfig.authentication) {
        if (this.remoteConfig.tokenStorage == 'localStorage') {
